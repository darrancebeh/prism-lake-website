...
export function ResearchSection() {
  ...
  if (loading) {
    return (
      <section className="py-32 relative max-w-7xl mx-auto px-4 z-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6 border-b border-[#1b17ff]/10 pb-8">
        <div>
          ...
          <p className="mt-4 text-gray-400 max-w-xl text-lg font-light leading-relaxed">
            <span className="text-md font-mono text-[#1b17ff] tracking-wide uppercase">Prism Intelligence </span>is our proprietary research arm. We publish <strong>institutional-level coverage</strong> on real-time market dynamics, news, ongoing events and catalysts, and educational deep-dives.
          </p>
        </div>
