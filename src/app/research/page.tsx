...
import { ArrowRight, Clock, Hash, Zap, Cpu, Search, Terminal, BookOpen, Pin, Globe } from "lucide-react";
import { ArchiveGrid } from "@/components/ArchiveGrid"; // Import the new component
...
export default async function ResearchPage() {
  ...
  // LOGIC: 
  // 1. Featured = Newest (or Pinned)
  const featuredPost = allPosts[0]; 
  // 2. The Wire = Next 3
  const theWire = allPosts.slice(1, 4); 
  // 3. Archive = Everything else (passed to the client component)
  ...
  return (
    <div className="min-h-screen bg-[#020410] pt-32 pb-20 px-4 md:px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* ... Header & Marquee (Keep exactly as before) ... */}
        {/* (I am omitting the header code block to focus on the change, keep your existing Header) */}
        {/* HEADER START */}
                      ...
                      <div className="flex items-center gap-3">
                        <div className="relative w-10 h-10 rounded-full overflow-hidden border border-white/20 p-[1px] bg-gradient-to-tr from-[#1b17ff] to-cyan-500">
                           <div className="w-full h-full rounded-full overflow-hidden relative">
                             <Image src="/images/darrancebeh2.jpg" alt="Author" fill className="object-cover" />
                           </div>
                        </div>
